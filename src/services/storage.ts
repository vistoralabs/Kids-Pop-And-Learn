...
/** Learning language: English, Hindi, or both. */
...
function read(): Progress {
  ...
  try {
    ...
    let langSetting: Lang = "both";
    if (parsed.settings?.lang === "en" || parsed.settings?.lang === "hi" || parsed.settings?.lang === "both") {
      langSetting = parsed.settings.lang;
    }
